...
badbolos=[badbolos,more_badbolos]
...
pixsize_arcsec=[6,8.333333333333333,12]/2.;3.;6.
pixsize_arcsec=[4.,4.,4.]
;;1/5 size pixels
pixscale = [6,8.333333333333333,12]/2.;(5*3600.0)
...
st=SMAP_WRITE3COLORS("neptune",map250,map350,map500,$
                     /SILENT,ERRMSG=errmsg,EXNAME=exname2+pixsize_suffix)
