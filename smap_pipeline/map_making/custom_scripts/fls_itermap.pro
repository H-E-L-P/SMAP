PRO FLS_ITERMAP, DATADIR=datadir, EXNAME=exname_in, DO_JACKKNIFE=do_jackknife, $
  ...
  IF NOT KEYWORD_SET(datadir) THEN $
     datadir = "/data/spiredaq/reprocessed/FLS_L1e/"

  IF KEYWORD_SET(exname_in) THEN exname = exname_in ELSE exname = 'fls_'+exname_def
