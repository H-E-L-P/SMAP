PRO ELAISS1_ITERMAP, DATADIR=datadir, EXNAME=exname_in, $
  ...
  IF NOT KEYWORD_SET(datadir) THEN $
     datadir = "/data/spiredaq/reprocessed/ELAIS-S1-NewSWIRE_L1e/"

  IF KEYWORD_SET(exname_in) THEN exname = exname_in ELSE exname = 'elais-s1_'+exname_def
