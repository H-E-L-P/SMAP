...
;       David Fanning's cgImage  http://www.dfanning.com/programs/cgimage.pro
...
;
;       IDL> cgimage,im1,/keep_aspect, position = pos,/half
 ...
 xratio = xsize / float(ysize)
  ...
  if ( ylength*xratio LT xlength ) then begin
    ...
    pos = [ 0.15, 0.15, xmax, 0.95 ]
     ...
     xmax = 0.95
     pos = [ 0.2, 0.2, xmax, 0.15+ 0.8*xlength*yratio/ylength ]
