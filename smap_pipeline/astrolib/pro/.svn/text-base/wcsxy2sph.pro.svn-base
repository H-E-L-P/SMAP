...
; 3.5.2  Jan 2014  W. Landsman In HPX set PV2 = [4.d,3.d] if supplied as [0,0]
;-
...
; equation for phi
  ...
  'HPX':begin ; HEALPix projection
    ...
    pv2_1 = (N_ELEMENTS(pv2) GE 1 && pv2[0] NE 0.0) ? pv2[0] : 4.d
    pv2_2 = (N_ELEMENTS(pv2) GE 2 && pv2[1] NE 0.0) ? pv2[1] : 3.d
    ...
    IF (ik le 0 || ih le 0) THEN MESSAGE, $
      'Illegal PV2 array:[' + strjoin(pv2,',') + '] - should be positive integers'
