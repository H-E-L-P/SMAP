; $Id: mk_html_help.pro,v 1.1 2005/06/17 14:16:45 conley Exp $
;+
; NAME:
;	MK_HTML_HELP
;
 ...
 WHILE (1) DO BEGIN
  ...
  IF (found) THEN BEGIN
   ...
   IF (count eq 1) THEN BEGIN
    ...
    ;; Added by D. Windt:
    ;;
    ;; If sub is null, then get next line of text as name:
    ;; 
    if sub eq '' then sub = STRUPCASE(STRTRIM(header(index(0)+2), 2))
