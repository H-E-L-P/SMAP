...
dir_map_to_observe='/data/viero/maps/IRIS/'+field_ids[field_num]+'/'
;THIS STRING SHOULD BE A 1X3 STRING ARRAY FOR 250,350,500        ;
filemapname=strcompress('source_filled_sky_clustering_bias_1.0'+$;
   '_cut_1000mJy_2x2048x2048_0_'+$                               ;
   string(wavelength[0:2],format='(i10)'),/remove_all)           ;
filemapname=strcompress('clean_sky_2'+$			         ;
   'x10580x10580_0' ,/remove_all)			         ;

filemapname=strcompress(field_ids[field_num]+$	 ;
   '_iris_mosaic_12.0_arcsec_pixels_100',/remove_all)		 ;
                                                                 ;
