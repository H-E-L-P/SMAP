...
FUNCTION BIASED_SKYMODEL3,$
  ...
  cold_file=dir_templates+'cold.fits'
  starburst_file=dir_templates+'starburst.fits'
  cold = mrdfits(cold_file,1,head)
  starburst = mrdfits(starburst_file,1,head)
