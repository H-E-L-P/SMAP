PRO SMAP_TRANSFUN_MAKEMAP_V6,datadirbase, dataname, dataversion, $
...
nmap=n_elements(mapfiles)
if nmap eq 3 then begin
   if KEYWORD_SET(cleansky) then begin
...
;IS THIS OPTIMIZED FOR ONLY ONE MAP?
; noiseless timelines
