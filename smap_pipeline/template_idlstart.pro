...
defsysv,'!SMAP_DATA','/home/viero/data/'
;; Now let's define the path to SPIRE source catalogs
defsysv,'!SMAP_CATS','/home/viero/cats/'
;; and finally the path to SPIRE maps
defsysv,'!SMAP_MAPS','/home/viero/maps/hermes/'
...
defsysv,'!IRISDATA','/home/viero/data/'; - should point at the directory where the IRIS data are
...
!PATH=EXPAND_PATH('+'+'/home/viero/viero_idl_functions/coyote/',/ALL_DIRS)+':'+!PATH
