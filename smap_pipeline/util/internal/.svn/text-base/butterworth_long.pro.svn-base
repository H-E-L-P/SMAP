;; $Id: //depot/idl/IDL_71/idldir/lib/butterworth.pro#1 $
;;
...
;;   Modified by MZ, Aug 2010 - added capability to handle large x values.
;-

FUNCTION butterworth_long, xin, yin, zin, $
